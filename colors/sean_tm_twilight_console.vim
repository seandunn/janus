...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
  ...
  CSAHi   erubyComment                   term=NONE             cterm=NONE             ctermbg=bg    ctermfg=239   gui=italic                guibg=bg             guifg=#504c51
  ...
  CSAHi   CursorLine                     term=underline        cterm=NONE             ctermbg=12    ctermfg=fg    gui=NONE                  guibg=#0B2F4F        guifg=fg
  ...
  CSAHi   StatusLine                     term=italic           cterm=NONE             ctermbg=237    ctermfg=231   gui=italic                guibg=#92432E        guifg=#ffffff
  ...
  CSAHi   Visual                         term=reverse          cterm=NONE             ctermbg=26    ctermfg=fg    gui=NONE                  guibg=#0051d4        guifg=fg
  ...
  CSAHi   Comment                        term=bold             cterm=NONE             ctermbg=bg    ctermfg=242   gui=italic                guibg=bg             guifg=#696969
  ...
  CSAHi   SpellBad                       term=underline        cterm=undercurl        ctermbg=bg    ctermfg=196   gui=undercurl             guibg=bg             guifg=fg          guisp=red
  CSAHi   SpellCap                       term=underline        cterm=undercurl        ctermbg=bg    ctermfg=226   gui=undercurl             guibg=bg             guifg=fg          guisp=yellow
  CSAHi   SpellRare                      term=underline        cterm=undercurl        ctermbg=bg    ctermfg=21    gui=undercurl             guibg=bg             guifg=fg          guisp=blue
...
elseif has("gui_running") || &t_Co == 88
  CSAHi   Normal                         term=NONE             cterm=NONE             ctermbg=80    ctermfg=79    gui=NONE                  guibg=#202020        guifg=#f5f5f5
  CSAHi   erubyDelimiter                 term=NONE             cterm=NONE             ctermbg=bg    ctermfg=fg    gui=NONE                  guibg=bg             guifg=fg
  CSAHi   erubyComment                   term=NONE             cterm=NONE             ctermbg=bg    ctermfg=81    gui=italic                guibg=bg             guifg=#504c51
  ...
  CSAHi   Todo                           term=NONE             cterm=bold             ctermbg=81    ctermfg=80    gui=reverse,bold,italic   guibg=bg             guifg=#504c51
  ...
  CSAHi   htmlTitle                      term=NONE             cterm=NONE             ctermbg=bg    ctermfg=fg    gui=NONE                  guibg=bg             guifg=fg
  CSAHi   diffAdded                      term=NONE             cterm=NONE             ctermbg=bg    ctermfg=fg    gui=NONE                  guibg=bg             guifg=fg
  CSAHi   SpecialKey                     term=bold             cterm=NONE             ctermbg=16    ctermfg=81    gui=NONE                  guibg=#092137        guifg=#494949
  CSAHi   NonText                        term=bold             cterm=NONE             ctermbg=80    ctermfg=80    gui=NONE                  guibg=bg             guifg=bg
  CSAHi   Directory                      term=bold             cterm=NONE             ctermbg=bg    ctermfg=53    gui=NONE                  guibg=bg             guifg=#cf6a4c
  CSAHi   ErrorMsg                       term=NONE             cterm=NONE             ctermbg=bg    ctermfg=fg    gui=NONE                  guibg=bg             guifg=fg
  CSAHi   IncSearch                      term=reverse          cterm=NONE             ctermbg=48    ctermfg=79    gui=italic                guibg=#b00000        guifg=#ffffff
  CSAHi   Search                         term=reverse          cterm=NONE             ctermbg=32    ctermfg=79    gui=italic                guibg=#660D11        guifg=#ffffff
  CSAHi   MoreMsg                        term=bold             cterm=bold             ctermbg=bg    ctermfg=21    gui=bold                  guibg=bg             guifg=SeaGreen
  CSAHi   ModeMsg                        term=bold             cterm=bold             ctermbg=bg    ctermfg=fg    gui=bold                  guibg=bg             guifg=fg
  CSAHi   LineNr                         term=underline        cterm=bold             ctermbg=80    ctermfg=80    gui=bold,italic           guibg=bg             guifg=#3F3F3F
  CSAHi   IndentGuidesEven               term=NONE             cterm=NONE             ctermbg=bg    ctermfg=fg    gui=NONE                  guibg=bg             guifg=fg
  CSAHi   rubyRepeat                     term=NONE             cterm=NONE             ctermbg=bg    ctermfg=fg    gui=NONE                  guibg=bg             guifg=fg
  ...
  CSAHi   rubyClass                      term=NONE             cterm=bold             ctermbg=bg    ctermfg=53    gui=bold                  guibg=bg             guifg=#cda869
  ...
  CSAHi   Pmenu                          term=NONE             cterm=NONE             ctermbg=16    ctermfg=36    gui=italic                guibg=#000000        guifg=#9b703f
  CSAHi   PmenuSel                       term=NONE             cterm=bold             ctermbg=22    ctermfg=fg    gui=bold,italic           guibg=#0051d4        guifg=fg
  ...
  CSAHi   CursorColumn                   term=reverse          cterm=NONE             ctermbg=16    ctermfg=fg    gui=NONE                  guibg=#092137        guifg=fg
  CSAHi   CursorLine                     term=underline        cterm=NONE             ctermbg=12    ctermfg=fg    gui=NONE                  guibg=#0B2F4F        guifg=fg
  ...
  CSAHi   StatusLine                     term=italic           cterm=NONE             ctermbg=237    ctermfg=79    gui=italic                guibg=#92432E        guifg=#ffffff
  CSAHi   StatusLineNC                   term=reverse          cterm=NONE             ctermbg=237    ctermfg=79    gui=italic                guibg=#393939        guifg=#f8f8f8
  CSAHi   VertSplit                      term=reverse          cterm=NONE             ctermbg=80    ctermfg=80    gui=NONE                  guibg=#393939        guifg=#393939
  CSAHi   Title                          term=bold             cterm=bold             ctermbg=bg    ctermfg=79    gui=bold                  guibg=bg             guifg=#f8f8f8
  CSAHi   Visual                         term=reverse          cterm=NONE             ctermbg=22    ctermfg=fg    gui=NONE                  guibg=#0051d4        guifg=fg
  CSAHi   VisualNOS                      term=bold,underline   cterm=bold,underline   ctermbg=bg    ctermfg=fg    gui=bold,underline        guibg=bg             guifg=fg
  CSAHi   WarningMsg                     term=NONE             cterm=NONE             ctermbg=bg    ctermfg=fg    gui=NONE                  guibg=bg             guifg=fg
  CSAHi   WildMenu                       term=NONE             cterm=NONE             ctermbg=76    ctermfg=16    gui=NONE                  guibg=Yellow         guifg=Black
  CSAHi   Folded                         term=NONE             cterm=bold             ctermbg=16    ctermfg=81    gui=bold                  guibg=#000000        guifg=#504c51
  ...
  CSAHi   Cursor                         term=NONE             cterm=NONE             ctermbg=22    ctermfg=79    gui=NONE                  guibg=#0052D5        guifg=#ffffff
  ...
  CSAHi   Comment                        term=bold             cterm=NONE             ctermbg=bg    ctermfg=82    gui=italic                guibg=bg             guifg=#696969
  ...
  CSAHi   CtrlPPrtCursor                 term=NONE             cterm=bold             ctermbg=bg    ctermfg=fg    gui=bold                  guibg=bg             guifg=fg
  CSAHi   CtrlPPrtText                   term=NONE             cterm=NONE             ctermbg=bg    ctermfg=79    gui=NONE                  guibg=bg             guifg=#ffffff
  CSAHi   rubyConditional                term=NONE             cterm=NONE             ctermbg=bg    ctermfg=fg    gui=NONE                  guibg=bg             guifg=fg
  CSAHi   coffeeRepeat                   term=NONE             cterm=NONE             ctermbg=bg    ctermfg=fg    gui=NONE                  guibg=bg             guifg=fg
  CSAHi   coffeeKeyword                  term=NONE             cterm=NONE             ctermbg=bg    ctermfg=fg    gui=NONE                  guibg=bg             guifg=fg
  CSAHi   coffeeSpecialVar               term=NONE             cterm=NONE             ctermbg=bg    ctermfg=fg    gui=NONE                  guibg=bg             guifg=fg
  ...
  CSAHi   FoldColumn                     term=NONE             cterm=NONE             ctermbg=16    ctermfg=83    gui=NONE                  guibg=#000000        guifg=#828282
  ...
  CSAHi   SignColumn                     term=NONE             cterm=NONE             ctermbg=85    ctermfg=12    gui=NONE                  guibg=Grey           guifg=DarkBlue
  CSAHi   Conceal                        term=NONE             cterm=NONE             ctermbg=84    ctermfg=86    gui=NONE                  guibg=DarkGrey       guifg=LightGrey
  CSAHi   SpellBad                       term=underline        cterm=undercurl        ctermbg=bg    ctermfg=64    gui=undercurl             guibg=bg             guifg=fg          guisp=red
  CSAHi   SpellCap                       term=underline        cterm=undercurl        ctermbg=bg    ctermfg=76    gui=undercurl             guibg=bg             guifg=fg          guisp=yellow
  CSAHi   SpellRare                      term=underline        cterm=undercurl        ctermbg=bg    ctermfg=19    gui=undercurl             guibg=bg             guifg=fg          guisp=blue
